...
import styles from '../../../styles/modules/global/transport/RequestFormBase.module.css'
import TimePickerModal from './TimePickerModal'
import useBodyScrollLock from '../../../hooks/useBodyScrollLock'
import ModalCloseButton from '../common/ModalCloseButton'
import type { RequestFormValues } from './types'

const requestTypeOptions: RequestFormValues['requestType'][] = [
  'DRIVER ONLY',
  'VEHICLE ONLY',
  'DRIVER AND VEHICLE',
  'GENSET',
...
export default function RequestFormBase({
  mode,
  onClose,
  onSubmit,
  initialValues,
